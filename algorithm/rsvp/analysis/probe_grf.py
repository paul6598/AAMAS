...
Usage (grf env, repo root):
  python algorithm/rsvp/probe_grf.py --episodes 10 --api http://n020:8356/v1
"""
import argparse
import json
import os
...
from algorithm.rsvp.commander.grf import GRFLLMCommander  # noqa: E402
...
def main():
    ...
    out = a.out or os.path.join(REPO, "results", "rsvp",
